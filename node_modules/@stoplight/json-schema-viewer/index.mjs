...
function getApplicableFormats(schemaNode) {
    if (isPlainObject(schemaNode.fragment) &&
        ...
        React.createElement(Flex, { maxW: "full", pl: pl, py: 2, "data-id": originalNodeId, "data-test": "schema-row", pos: "relative", onMouseEnter: (e) => {
            ...
            React.createElement(VStack, { spacing: 1, maxW: "full", flex: 1, ml: isCollapsible && !isRootLevel ? 2 : undefined },
                ...
                typeof description === 'string' &&
                    (!combiner || ((_c = schemaNode.parent) === null || _c === void 0 ? void 0 : _c.fragment.description) !== description) &&
                    description.length > 0 && React.createElement(Description, { value: description }),
            ...
            React.createElement(Error$1, { schemaNode: schemaNode }),
...
const TopLevelSchemaRow = ({ schemaNode, skipDescription, }) => {
    ...
    if (isRegularNode(schemaNode) && choices.length > 1) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(ScrollCheck, null),
            schemaNode.annotations.description !== ((_b = schemaNode.parent) === null || _b === void 0 ? void 0 : _b.fragment.description) && (React.createElement(Description, { value: schemaNode.annotations.description })),
...
const JsonSchemaViewerInner = ({ schema, viewMode, className, resolveRef, maxRefDepth, emptyText = 'No schema defined', onTreePopulated, maxHeight, parentCrumbs, skipTopLevelDescription, }) => {
    ...
    if (isEmpty) {
        return (React.createElement(Box, { className: cn(className, 'JsonSchemaViewer'), fontSize: "sm", "data-test": "empty-text" }, emptyText));
    }
